...
class RegisterUserForm(forms.Form):
    email = forms.EmailField(label='', required=True,max_length=128,
                             widget=forms.EmailInput(attrs={"class":"form-control","placeholder":"ایمیل"}))
    password1 = forms.CharField(label='', max_length=64, required=True,
                               widget=forms.PasswordInput(attrs={"class":"form-control","placeholder":"رمز عبور"}))
    password2 = forms.CharField(label='', max_length=64, required=True,
